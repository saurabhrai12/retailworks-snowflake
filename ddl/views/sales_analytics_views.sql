...
CREATE OR REPLACE VIEW VW_TERRITORY_SALES_ANALYSIS AS
SELECT 
    sr.TERRITORY_NAME,
    sr.REGION,
    sr.COUNTRY,
...
CREATE OR REPLACE VIEW VW_SALES_TREND_ANALYSIS AS
SELECT 
    d.DATE_ACTUAL,
    d.DAY_OF_WEEK_NAME,
    d.MONTH_NAME,
...
GRANT SELECT ON ALL VIEWS IN SCHEMA ANALYTICS_SCHEMA TO ROLE ANALYST_ROLE;