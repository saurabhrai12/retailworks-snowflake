...
CREATE OR ALTER TABLE STG_CUSTOMERS_RAW (
...
CREATE OR ALTER TABLE STG_PRODUCTS_RAW (
...
CREATE OR ALTER TABLE STG_ORDERS_RAW (
...
CREATE OR ALTER TABLE STG_ORDER_ITEMS_RAW (
    ORDER_NUMBER VARCHAR(20),
    PRODUCT_NUMBER VARCHAR(25),
    QUANTITY VARCHAR(20),
    UNIT_PRICE VARCHAR(20),
...
CREATE OR ALTER TABLE DATA_QUALITY_ISSUES (
...
CREATE OR ALTER TABLE ETL_PROCESS_LOG (
...
CREATE OR ALTER TABLE DATA_LINEAGE (
...
CREATE OR ALTER TABLE STG_CUSTOMERS_CLEAN (
    CUSTOMER_NUMBER VARCHAR(20),
    CUSTOMER_TYPE VARCHAR(20),
    COMPANY_NAME VARCHAR(100),
    FIRST_NAME VARCHAR(50),
...
CREATE OR ALTER TABLE STG_PRODUCTS_CLEAN (
    PRODUCT_NUMBER VARCHAR(25),
    PRODUCT_NAME VARCHAR(100),
    CATEGORY_NAME VARCHAR(50),
    SUPPLIER_NAME VARCHAR(100),
