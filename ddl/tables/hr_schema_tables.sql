...
-- Departments Table
CREATE OR ALTER TABLE DEPARTMENTS (
...
-- Positions Table
CREATE OR ALTER TABLE POSITIONS (
...
CREATE OR ALTER TABLE EMPLOYEE_PERFORMANCE (
...
-- This may produce a warning if constraint already exists, which is handled by deployment script
