...
CREATE OR ALTER TABLE DATE_DIM (
...
CREATE OR ALTER TABLE CUSTOMER_DIM (
...
CREATE OR ALTER TABLE PRODUCT_DIM (
...
CREATE OR ALTER TABLE SALES_REP_DIM (
...
-- Sales Fact Table
CREATE OR ALTER TABLE SALES_FACT (
...
CREATE OR ALTER TABLE CUSTOMER_LTV_FACT (
...
CREATE OR ALTER TABLE PRODUCT_PERFORMANCE_FACT (
