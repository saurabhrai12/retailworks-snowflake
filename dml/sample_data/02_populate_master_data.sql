...
-- Populate Employees using INSERT SELECT to avoid subqueries in VALUES
-- Sales Team
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Bob Johnson', '+1-555-4001', 'Spouse'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SALES_DIR' AND d.DEPARTMENT_CODE = 'SALES';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Mary Smith', '+1-555-4002', 'Mother'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SALES_MGR' AND d.DEPARTMENT_CODE = 'SALES';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'James Davis', '+1-555-4003', 'Father'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SR_SALES_REP' AND d.DEPARTMENT_CODE = 'SALES';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Lisa Wilson', '+1-555-4004', 'Spouse'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SALES_REP' AND d.DEPARTMENT_CODE = 'SALES';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Tom Brown', '+1-555-4005', 'Spouse'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SALES_REP' AND d.DEPARTMENT_CODE = 'SALES';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Maria Garcia', '+1-555-4006', 'Spouse'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'ENG_MGR' AND d.DEPARTMENT_CODE = 'ENG';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Carlos Martinez', '+1-555-4007', 'Brother'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SR_SW_ENG' AND d.DEPARTMENT_CODE = 'ENG';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Helen Anderson', '+1-555-4008', 'Mother'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'SW_ENG' AND d.DEPARTMENT_CODE = 'ENG';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Mark Taylor', '+1-555-4009', 'Spouse'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'MKT_MGR' AND d.DEPARTMENT_CODE = 'MKT';
...
SELECT 
    ...
    p.POSITION_ID, d.DEPARTMENT_ID, 'FULL_TIME', 'ACTIVE', 'Jennifer Lee', '+1-555-4010', 'Sister'
FROM POSITIONS p, DEPARTMENTS d 
WHERE p.POSITION_CODE = 'MKT_SPEC' AND d.DEPARTMENT_CODE = 'MKT';

-- Update manager relationships using LIMIT to handle potential duplicates
UPDATE EMPLOYEES SET MANAGER_ID = (SELECT EMPLOYEE_ID FROM EMPLOYEES WHERE EMPLOYEE_NUMBER = 'EMP002' LIMIT 1) WHERE EMPLOYEE_NUMBER IN ('EMP003', 'EMP004', 'EMP005');
UPDATE EMPLOYEES SET MANAGER_ID = (SELECT EMPLOYEE_ID FROM EMPLOYEES WHERE EMPLOYEE_NUMBER = 'EMP006' LIMIT 1) WHERE EMPLOYEE_NUMBER IN ('EMP007', 'EMP008');
UPDATE EMPLOYEES SET MANAGER_ID = (SELECT EMPLOYEE_ID FROM EMPLOYEES WHERE EMPLOYEE_NUMBER = 'EMP009' LIMIT 1) WHERE EMPLOYEE_NUMBER = 'EMP010';

-- Switch to Sales Schema for sales reps
USE SCHEMA SALES_SCHEMA<% schema_suffix %>;

-- Clear any existing sales reps to avoid duplicates
DELETE FROM SALES_REPS;

-- Populate Sales Reps (linking to employees) with distinct records
...
SELECT DISTINCT
    ...
    CASE 
        WHEN e.EMPLOYEE_NUMBER = 'EMP003' THEN (SELECT TERRITORY_ID FROM SALES_TERRITORIES WHERE TERRITORY_CODE = 'NE_US' LIMIT 1)
        WHEN e.EMPLOYEE_NUMBER = 'EMP004' THEN (SELECT TERRITORY_ID FROM SALES_TERRITORIES WHERE TERRITORY_CODE = 'MW_US' LIMIT 1)
        WHEN e.EMPLOYEE_NUMBER = 'EMP005' THEN (SELECT TERRITORY_ID FROM SALES_TERRITORIES WHERE TERRITORY_CODE = 'SW_US' LIMIT 1)
        ELSE (SELECT TERRITORY_ID FROM SALES_TERRITORIES WHERE TERRITORY_CODE = 'NE_US' LIMIT 1)
    END,
    e.HIRE_DATE, 
    CASE 
...
AND NOT EXISTS (SELECT 1 FROM SALES_REPS sr WHERE sr.EMPLOYEE_ID = e.EMPLOYEE_ID);
...
-- Populate Customers using INSERT SELECT
...
SELECT 'CUST001', 'CORPORATE', 'TechCorp Solutions', 'John', 'Anderson', 'CEO', 'john.anderson@techcorp.com', '+1-555-1001', '+1-555-2001', 
       '1975-05-15', 'M', 2500000, cs.SEGMENT_ID, 1, 1, '2022-01-10', 500000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Enterprise';
...
SELECT 'CUST002', 'CORPORATE', 'Global Enterprises Inc', 'Maria', 'Rodriguez', 'CTO', 'maria.rodriguez@globalent.com', '+1-555-1002', '+1-555-2002',
       '1978-09-22', 'F', 1800000, cs.SEGMENT_ID, 2, 2, '2022-02-15', 400000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Enterprise';
...
SELECT 'CUST003', 'CORPORATE', 'Innovation Systems LLC', 'Robert', 'Chen', 'VP Technology', 'robert.chen@innovsys.com', '+1-555-1003', '+1-555-2003',
       '1980-12-08', 'M', 1200000, cs.SEGMENT_ID, 3, 3, '2021-11-20', 300000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Enterprise';
...
SELECT 'CUST004', 'CORPORATE', 'MidSize Tech Co', 'Sarah', 'Williams', 'IT Director', 'sarah.williams@midsizetech.com', '+1-555-1004', '+1-555-2004',
       '1982-03-30', 'F', 450000, cs.SEGMENT_ID, 4, 4, '2022-04-05', 100000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Corporate';
...
SELECT 'CUST005', 'CORPORATE', 'Business Solutions Ltd', 'Michael', 'Thompson', 'Operations Manager', 'michael.thompson@bizsol.com', '+1-555-1005', '+1-555-2005',
       '1979-07-18', 'M', 320000, cs.SEGMENT_ID, 5, 5, '2022-03-12', 75000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Corporate';
...
SELECT 'CUST006', 'CORPORATE', 'Digital Dynamics', 'Jennifer', 'Lee', 'IT Manager', 'jennifer.lee@digitaldyn.com', '+1-555-1006', '+1-555-2006',
       '1984-11-05', 'F', 280000, cs.SEGMENT_ID, 6, 6, '2021-12-08', 60000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Corporate';
...
SELECT 'CUST007', 'CORPORATE', 'StartupTech', 'David', 'Kim', 'Founder', 'david.kim@startuptech.com', '+1-555-1007', '+1-555-2007',
       '1990-02-14', 'M', 85000, cs.SEGMENT_ID, 7, 7, '2022-05-20', 25000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Small Business';
...
SELECT 'CUST008', 'CORPORATE', 'Local Business Co', 'Lisa', 'Brown', 'Owner', 'lisa.brown@localbiz.com', '+1-555-1008', '+1-555-2008',
       '1986-08-27', 'F', 65000, cs.SEGMENT_ID, 8, 8, '2022-06-15', 20000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Small Business';
...
SELECT 'CUST009', 'CORPORATE', 'Consulting Plus', 'James', 'Wilson', 'Principal', 'james.wilson@consultplus.com', '+1-555-1009', '+1-555-2009',
       '1983-04-12', 'M', 72000, cs.SEGMENT_ID, 9, 9, '2021-10-30', 18000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Small Business';
...
SELECT 'CUST010', 'CORPORATE', 'Creative Agency', 'Amanda', 'Davis', 'Creative Director', 'amanda.davis@creative.com', '+1-555-1010', '+1-555-2010',
       '1988-06-09', 'F', 58000, cs.SEGMENT_ID, 10, 10, '2022-07-22', 15000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Small Business';
...
SELECT 'CUST011', 'INDIVIDUAL', NULL, 'Kevin', 'Martinez', 'Freelancer', 'kevin.martinez@email.com', '+1-555-1011', '+1-555-2011',
       '1992-01-25', 'M', 45000, cs.SEGMENT_ID, 11, 11, '2022-08-14', 5000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Individual';
...
SELECT 'CUST012', 'INDIVIDUAL', NULL, 'Rachel', 'Garcia', 'Consultant', 'rachel.garcia@email.com', '+1-555-1012', '+1-555-2012',
       '1989-10-18', 'F', 52000, cs.SEGMENT_ID, 12, 12, '2022-09-05', 7500, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Individual';
...
SELECT 'CUST013', 'INDIVIDUAL', NULL, 'Daniel', 'Taylor', 'Designer', 'daniel.taylor@email.com', '+1-555-1013', '+1-555-2013',
       '1991-12-03', 'M', 38000, cs.SEGMENT_ID, 13, 13, '2021-11-12', 4000, 'ACTIVE', FALSE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Individual';
...
SELECT 'CUST014', 'INDIVIDUAL', NULL, 'Nicole', 'White', 'Developer', 'nicole.white@email.com', '+1-555-1014', '+1-555-2014',
       '1987-05-29', 'F', 67000, cs.SEGMENT_ID, 14, 14, '2022-10-07', 8000, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Individual';
...
SELECT 'CUST015', 'INDIVIDUAL', NULL, 'Andrew', 'Johnson', 'Writer', 'andrew.johnson@email.com', '+1-555-1015', '+1-555-2015',
       '1985-09-16', 'M', 42000, cs.SEGMENT_ID, 15, 15, '2022-01-28', 3500, 'ACTIVE', TRUE
FROM CUSTOMER_SEGMENTS cs WHERE cs.SEGMENT_NAME = 'Individual';
